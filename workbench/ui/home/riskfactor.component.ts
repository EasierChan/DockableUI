        ...
        if(!isNaN(this.hedgeRadio)){
            ...
            if(strategyIndex>0){
                ...
                this.tradePoint.addSlot({
                 ...
                 this.netTableValue=[];
                 this.tradePoint.send(260, 226, { body: { type:1, id:tblockId, trday:this.startDate, begin_date:this.startDate, end_date:this.startDate}});
