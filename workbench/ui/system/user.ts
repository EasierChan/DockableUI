...
export class UserComponent implements OnInit {
    ...
    login() {
        ...
        let loginObj: any = { maid: this.maid, cellid: "*", userid: this.userid, password: this.cryptoSrv.generateMD5(this.password), termid: "12.345", conlvl: 2, clientesn: "", clienttm: stimestamp };
